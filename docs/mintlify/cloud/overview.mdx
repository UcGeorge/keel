...
- **Email notifications** — your SMTP server, recipients subscribed to the
  events they care about: runs starting, succeeding, or failing (with the
  last log lines), repository, target, and member changes.
- **AI insights** — a plain-language explanation of any failed run from
  the OpenAI-compatible model you configure.
